...
(function () {
    ...
    function toggleMobileMenu() {
        ...
        function openMobileMenu() {
            ...
            HERO_BUTTON.classList.add("mobile-menu-enabled");

            // Add Event Listener to each Navigation Link to close 
            for (let index = 0; index < NAVIGATION_LINKS.length; index++) {
                NAVIGATION_LINKS[index].classList.add("mobile-menu-enabled");
                NAVIGATION_LINKS[index].addEventListener("click", closeMobileMenu);
            }
        }
        ...
        function closeMobileMenu() {
            ...
            HERO_BUTTON.classList.remove("mobile-menu-enabled");

            // Remove Event Listeners from each Navigation Link
            for (let index = 0; index < NAVIGATION_LINKS.length; index++) {
                NAVIGATION_LINKS[index].classList.remove("mobile-menu-enabled");
                NAVIGATION_LINKS[index].removeEventListener("click", closeMobileMenu);
            }
        }
    }
})();